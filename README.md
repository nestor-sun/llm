...
<br/>
The wonderful visualization below (from this [survey paper](https://arxiv.org/abs/2304.13712) that summarizes the evolutionary tree of modern LLMs) traces the development of language models in recent years and highlights some of the most well-known models:
<p align="center">
